                  ...
                  <div className="mt-4 flex space-x-1">
                    {[
                      ...
                      <button
                        ...
                        className="px-3 py-2 text-sm font-medium rounded-lg transition-colors text-gray-600 hover:text-gray-900 hover:bg-white/60 flex items-center gap-1"
                      >
              ...
              <div className="flex-1 overflow-y-auto">
                <div className="px-6 lg:px-8 py-8 space-y-8">
                  ...
                  <section id="section-overview" className="space-y-6">
                    ...
                    {vhost.type === 'static' && (
                      <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-white/20 shadow-lg p-6">
                        <h4 className="text-sm font-medium text-gray-900 mb-4">Static Site Configuration</h4>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="md:col-span-2">
                            <p className="text-sm text-gray-600">Static Path</p>
                            <code className="text-sm bg-gray-100 px-3 py-1 rounded-lg text-gray-800">
                              {vhost.static_path || '/var/www/static'}
                            </code>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="sticky bottom-0 bg-gradient-to-t from-white via-white to-transparent pt-8 pb-4">
                      <div className="flex justify-end gap-3">
                        ...
                        <button
                          ...
                          className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-medium shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50"
                        >
