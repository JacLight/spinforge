      ...
      >
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Welcome to SpinForge Hosting
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            A high-performance static site hosting platform powered by OpenResty
            with dynamic routing, Redis-based configuration, and instant deployments.
          </p>
        </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <p className="text-xs text-gray-500">
                  {metrics?.totalSites || 0} hosted sites
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-gray-700">Active Sites</span>
                </div>
                <span className="text-sm font-medium">
                  {metrics?.activeSites || 0} / {metrics?.totalSites || 0}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center">
        ...
        <div className="bg-indigo-50 rounded-lg p-8 text-center">
          <h2 className="text-2xl font-bold text-indigo-900 mb-4">
            Ready to host your first site?
          </h2>
          <p className="text-indigo-700 mb-6 max-w-2xl mx-auto">
            SpinForge Hosting makes it easy to deploy static sites
            with instant routing, SSL certificates, and custom domains.
          </p>
