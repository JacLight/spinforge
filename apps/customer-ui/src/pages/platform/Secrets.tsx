...
export default function PlatformSecrets() {
  ...
  async function onDeleteKey(k: string) {
    const ok = await confirm({
      title: 'Destroy platform secret?',
      description: `Permanently destroys ALL versions of secret/platform/${k}. Nomad Variables that depend on it will need to be rebuilt. This cannot be undone.`,
      severity: 'danger',
