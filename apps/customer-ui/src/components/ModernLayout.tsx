...
const groupedNav: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/activity", icon: ShieldAlert, label: "Activity", color: "from-slate-500 to-slate-600" },
    ],
  },
];
      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div className="border-t border-gray-200 p-4 space-y-2">
            <Link
              to="/profile"
              className="flex items-center rounded-xl px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-100 transition-all"
            >
            ...
            <button
              ...
              className="flex items-center w-full rounded-xl px-4 py-3 text-sm font-medium text-red-600 hover:bg-red-50 transition-all"
            >
