...
import {
  Search, Server, Package, ShieldAlert, Settings,
  Home, Monitor, Upload, FileCode, Rocket,
...
const NAV_ITEMS: Array<{ path: string; label: string; icon: Icon; desc?: string }> = [
  { path: '/welcome', label: 'Overview', icon: Home },
  ...
  { path: '/activity', label: 'Activity', icon: ShieldAlert },
