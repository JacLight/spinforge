#!/bin/bash
# Wrapper script for API to start Flutter containers with custom environment
...
echo "Starting Flutter container with:"
echo "  ORG_ID: $ORG_ID"
...
echo "Started Flutter container for $ORG_ID-$ENVIRONMENT on port $DEV_PORT"