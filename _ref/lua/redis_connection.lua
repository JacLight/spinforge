...
function _M.get_connection()
    ...
    -- Hardcode for now since env vars aren't accessible in OpenResty
    local redis_pass = "changeThisStrongPassword123"
    ngx.log(ngx.INFO, "Using hardcoded Redis password")
