// Copied from hosting/api/services/AdminService.js on 2026-04-20 — keep in sync
// until extracted to @spinforge/admin-auth (see SPINBUILD_PLAN.md M8). Validates
// login-JWT sessions (admin:session:<token>) written by hosting's /_admin/login.
/**
