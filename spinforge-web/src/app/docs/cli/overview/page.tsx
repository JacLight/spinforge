import { Terminal, Book, Key, Rocket, List, ScrollText, Settings } from "lucide-react";
...
export default function CLIOverviewPage() {
  const commands = [
    ...
    },
    {
      ...
      icon: Rocket,
      subcommands: [
        { name: "deploy-folder <path>", description: "Deploy specified folder" },
      ],
    },
    {
      name: "list",
    ...
    },
    {
      ...
      icon: ScrollText,
      subcommands: [
        { name: "logs <deployment-id>", description: "View logs for deployment" },
        { name: "logs <deployment-id> --follow", description: "Follow logs in real-time" },
      ],
    },
    {
      name: "config",
  ...
  return (
    <div className="prose prose-gray max-w-none">
      ...
      <p className="text-lg text-gray-600 mb-8">
        The SpinForge CLI provides a powerful command-line interface for deploying and managing your applications.
      </p>
      ...
      <div className="bg-gray-50 rounded-lg p-6 mb-8 not-prose">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-white p-4 rounded border border-gray-200">
            <code className="text-sm text-gray-800">spinforge-cli auth login</code>
            <p className="text-xs text-gray-600 mt-1">Authenticate with SpinForge</p>
          </div>
          <div className="bg-white p-4 rounded border border-gray-200">
            <code className="text-sm text-gray-800">spinforge-cli deploy</code>
            <p className="text-xs text-gray-600 mt-1">Deploy current directory</p>
          </div>
          <div className="bg-white p-4 rounded border border-gray-200">
          ...
          <div className="bg-white p-4 rounded border border-gray-200">
            <code className="text-sm text-gray-800">spinforge-cli logs &lt;id&gt;</code>
      ...
      <div className="bg-gray-900 rounded-lg p-6 mb-8 not-prose">
        <pre className="text-gray-100 overflow-x-auto"><code>--help, -h     Show help for command
...
--no-color     Disable colored output</code></pre>
      ...
      <div className="space-y-8 not-prose">
        {commands.map((cmd) => {
          const Icon = cmd.icon;
          return (
            <div key={cmd.name} className="bg-white rounded-lg border border-gray-200 p-6">
              <div className="flex items-start mb-4">
                <Icon className="h-6 w-6 text-indigo-600 mr-3 mt-0.5" />
                <div>
                  <h3 className="text-xl font-semibold text-gray-900">{cmd.name}</h3>
      ...
      <h2 className="text-2xl font-bold text-gray-900 mb-4 mt-12">Environment Variables</h2>

      <p className="mb-4">The CLI respects the following environment variables:</p>
      ...
      <h2 className="text-2xl font-bold text-gray-900 mb-4">Configuration File</h2>

      <p className="mb-4">
        The CLI stores configuration in <code className="bg-gray-100 px-2 py-1 rounded">~/.spinforge/config.json</code>:
      </p>

      <div className="bg-gray-900 rounded-lg p-6 mb-8 not-prose">
        <pre className="text-gray-100 overflow-x-auto"><code>{`{
  ...
  "analytics": true
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 not-prose">
        ...
        <p className="text-blue-800 mb-4">
          Get help for any command by adding the <code className="bg-blue-100 px-2 py-1 rounded">--help</code> flag.
        </p>
